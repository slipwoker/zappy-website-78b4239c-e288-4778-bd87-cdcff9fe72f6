  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && !validators.required(value)) {
        ...
        } else if (fieldType === 'tel' || field.dataset.validate === 'phone') {
        ...
        if (isValid && field.dataset.minlength) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '78b4239c-e288-4778-bd87-cdcff9fe72f6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '78b4239c-e288-4778-bd87-cdcff9fe72f6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '78b4239c-e288-4778-bd87-cdcff9fe72f6';
